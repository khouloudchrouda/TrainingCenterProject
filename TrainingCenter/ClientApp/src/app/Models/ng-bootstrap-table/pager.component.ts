...
@Component({
  ...
  <div class="d-flex justify-content-center"> 
                    <button class="btn-paginate" (click)="prevPage()" ><img src="assets/icons/circle-arrow-left.png" /></button>
                    <button class="btn-circle-paginate" *ngFor="let pg of pages" [class.active]="pg.number === page"><a href="javascript:void(0)" (click)="selectPage(pg.number)">{{pg.text}}</a></button>
                    <button class="btn-paginate" (click)="nextPage()"><img src="assets/icons/circle-arrow-right.png" /></button>
              </div>
  `,
  host: {
